        ...
        <div class="card z-index-2">
          <div class="card-body">
            <div class="card-header p-0">
              <h4 class="p-0">Masukin List Ip Nya</h4>
            </div>
            <hr class="dark horizontal" />
            <label for="floatingTextarea2">Masukin Disini ya bang</label>
            <div class="form-floating">
              <textarea id="keywords" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                style="height: 200px"></textarea>
            </div>
            <select class="form-control-lg btn-primary border-0" id="mySelect">
                <option value="1">1.1.1.1 (1 percobaan)</option>
                <option value="2">1.1.1.1 (1 kali)</option>
                <option value="3">1.1.1.1 - 1</option>
                <option value="4">1.1.1.1</option>
              </select>
              <input id="data" type="button" value="submit" class="btn btn-info my-3" onclick="rapihan()" />
          </div>
        </div>
      </div>
    ...
    <div class="row mt-4">
      <div class="col">
        <div class="card z-index-2">
          <div class="card-body">
            <div class="card-header p-0">
              <h4 class="p-0">Ini Hasil Filternya</h4>
            </div>
            <hr class="dark horizontal" />
            <label for="floatingTextarea2">Tinggal Di copy aja ya bang!</label>
            <div class="form-floating">
              <textarea id="ip" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2"
                style="height: 200px"></textarea>
            </div>
            <button type="button" onclick="salin()" class="btn btn-secondary mt-3" data-bs-toggle="tooltip" id="myTooltip"
                data-bs-placement="right" title="Ngopi">
                Copy &nbsp; <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
